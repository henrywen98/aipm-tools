...
按项目约定（`/Users/henry/dev/2_areas/aipm-tools/CLAUDE.md` 顶部 Version 行），push 后更新为：
...
- aipm-tools marketplace 根 CLAUDE.md Version 行：`v0.7.0 → v0.8.0 (2026-04-08)`（minor，因为插件行为改变；与改动 10 对齐）
